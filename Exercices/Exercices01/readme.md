...
# 🏋️‍♀️ Exercices 01 - Introduction 🏋️‍♀️

#### 📁 [Structures de projets & consignes à suivre](../../includes/rules.md)

## 7️⃣ Question 01 - Le 7 chanceux

Affichez à l'écran **chiffre** 7 qui doit être présent en **valeur numérique** dans votre code. Il est interdit de simplement afficher le caractère '7' :
